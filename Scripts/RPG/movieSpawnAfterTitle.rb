...
$game_map.setup(2) # this is where u choose which map u want the new game to start on (map_id)

$game_player.moveto(8, 6) # This is where u put in the coords of the map u want the new game to start on (x, y)
